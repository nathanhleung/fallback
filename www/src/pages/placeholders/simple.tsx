    ...
    >
      <main className="container px-6 mx-auto pb-20">
        <div className="text-center pt-16">
          <h1>Unavailable</h1>
          <p>
            Due to rising cloud costs, the simple example app at{" "}
            <a href="https://simple.fallback.natecation.xyz">
              simple.fallback.natecation.xyz
            </a>{" "}
            is currently unavailable.
          </p>
          <img className="lg:w-1/2" src="/img/placeholders/simple.png" />
        </div>
        <div className="pt-8">
          <h2>Self-Host</h2>
          <p>
...
SERVER_MODE=call
        ...
        <div className="pt-8">
          ...
          <ul>
            <li>
              Code:{" "}
              <a href="https://github.com/nathanhleung/fallback/blob/main/src/example/SimpleExample.sol">
                SimpleExample.sol
              </a>
            </li>
            <li>
              Live Contract on Optimism Goerli:{" "}
              <a href="https://goerli-optimism.etherscan.io/address/0x83707e88a05046a04b459d8d0eb1afcc404f92eb">
